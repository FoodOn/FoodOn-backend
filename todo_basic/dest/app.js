...
app.use('/image/:fileName', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var fileName, data, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, getImage_1.default)(fileName)];
            case 2:
                data = _a.sent();
